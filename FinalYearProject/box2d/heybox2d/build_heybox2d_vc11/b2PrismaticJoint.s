...
.LFB512:
	.file 4 "c:/Users/Ben/Desktop/FYP/FinalYearProject/box2d/Box2D/Dynamics/Joints/b2PrismaticJoint.cpp"
	.loc 4 91 0
	.cfi_startproc
...
.L100:
	.align	2
.L99:
	.word	_ZTV16b2PrismaticJoint-(.LPIC2+8)
	.cfi_endproc
.LFE514:
	...
	.set	_ZN16b2PrismaticJointC1EPK19b2PrismaticJointDef,_ZN16b2PrismaticJointC2EPK19b2PrismaticJointDef
...
.LBB31:
	.loc 4 421 0
	ldrb	r3, [sp, #395]	@ zero_extendqisi2
	cmp	r3, #0
	beq	.L140
.LBB32:
	.loc 4 423 0
...
.L141:
	...
	mov	r3, r0
	str	r3, [sp, #312]	@ float
	.loc 4 435 0 discriminator 1
	add	r3, sp, #24
	mov	r0, r3
	bl	_ZN7b2Mat33C1Ev(PLT)
	.loc 4 436 0 discriminator 1
	add	r3, sp, #24
	mov	r0, r3
	ldr	r1, [sp, #328]	@ float
	ldr	r2, [sp, #324]	@ float
	...
	mov	r0, r3
	bl	_ZN6b2Vec3C1Ev(PLT)
	.loc 4 441 0 discriminator 1
	ldr	r3, [sp, #104]	@ float
	str	r3, [sp, #84]	@ float
	.loc 4 442 0 discriminator 1
	ldr	r3, [sp, #108]	@ float
	str	r3, [sp, #88]	@ float
	.loc 4 443 0 discriminator 1
	ldr	r3, [sp, #388]	@ float
	str	r3, [sp, #92]	@ float
	.loc 4 445 0 discriminator 1
	add	r2, sp, #244
	add	r3, sp, #84
	mov	r0, r2
	mov	r1, r3
...
.L144:
	...
	.loc 4 462 0 discriminator 1
	ldr	r3, [sp, #60]	@ float
	str	r3, [sp, #112]	@ float
	.loc 4 463 0 discriminator 1
	ldr	r3, [sp, #64]	@ float
	str	r3, [sp, #116]	@ float
...
.L149:
.LBE27:
	.loc 4 482 0 is_stmt 1 discriminator 4
	mov	r0, r3
	add	sp, sp, #400
	@ sp needed
	ldmfd	sp!, {r4, pc}
...
.LC1:
	...
	.ascii	"2D/Dynamics/Joints/b2PrismaticJoint.cpp\000"
	.align	2
.LC2:
...
.LCFI100:
	...
	cmp	r3, #0
	bne	.L181
	.loc 4 564 0 is_stmt 0 discriminator 1
	ldr	r3, .L185
.LPIC3:
	add	r3, pc, r3
	mov	r0, r3
...
.L181:
	...
	cmp	r3, #0
	beq	.L182
	.loc 4 565 0 is_stmt 0 discriminator 1
	ldr	r3, [sp, #12]
	ldr	r3, [r3, #124]	@ float
	mov	r0, r3
	ldr	r1, [sp, #4]	@ float
...
_ZTV16b2PrismaticJoint:
	...
	.section	.text._ZN16b2PrismaticJointD2Ev,"axG",%progbits,_ZN16b2PrismaticJointD5Ev,comdat
	.align	2
	.weak	_ZN16b2PrismaticJointD2Ev
	.hidden	_ZN16b2PrismaticJointD2Ev
	.type	_ZN16b2PrismaticJointD2Ev, %function
_ZN16b2PrismaticJointD2Ev:
.LFB543:
	.file 5 "c:/users/ben/desktop/fyp/finalyearproject/box2d/Box2D/Dynamics/Joints/b2PrismaticJoint.h"
	.loc 5 86 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
...
.L225:
	.align	2
.L224:
	.word	_ZTV16b2PrismaticJoint-(.LPIC20+8)
	.cfi_endproc
.LFE543:
	.size	_ZN16b2PrismaticJointD2Ev, .-_ZN16b2PrismaticJointD2Ev
	.weak	_ZN16b2PrismaticJointD1Ev
	.hidden	_ZN16b2PrismaticJointD1Ev
	.set	_ZN16b2PrismaticJointD1Ev,_ZN16b2PrismaticJointD2Ev
...
.LCFI123:
	...
	.loc 5 86 0
	ldr	r0, [sp, #4]
	bl	_ZN16b2PrismaticJointD1Ev(PLT)
	ldr	r0, [sp, #4]
	bl	_ZdlPv(PLT)
	ldr	r3, [sp, #4]
	mov	r0, r3
...
.LASF618:
	.ascii	"indexB\000"
.LASF599:
	.ascii	"_ZN16b2PrismaticJointC2EPK19b2PrismaticJointDef\000"
.LASF636:
	.ascii	"c:/Users/Ben/Desktop/FYP/FinalYearProject/box2d/Box"
	.ascii	"2D/Dynamics/Joints/b2PrismaticJoint.cpp\000"
.LASF548:
...
.LASF628:
	.ascii	"_ZN16b2PrismaticJointD2Ev\000"
.LASF210:
...
.LASF629:
	.ascii	"_ZN16b2PrismaticJointD0Ev\000"
.LASF361:
