...
.LFE527:
	...
	.section	.text._ZN25b2PolygonAndCircleContactD2Ev,"axG",%progbits,_ZN25b2PolygonAndCircleContactD5Ev,comdat
	.align	2
	.weak	_ZN25b2PolygonAndCircleContactD2Ev
	.hidden	_ZN25b2PolygonAndCircleContactD2Ev
	.type	_ZN25b2PolygonAndCircleContactD2Ev, %function
_ZN25b2PolygonAndCircleContactD2Ev:
.LFB552:
	.file 5 "c:/users/ben/desktop/fyp/finalyearproject/box2d/Box2D/Dynamics/Contacts/b2PolygonAndCircleContact.h"
	.loc 5 33 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
...
.LBE3:
	...
	cmp	r3, #0
	beq	.L20
	.loc 5 33 0 is_stmt 0 discriminator 1
	ldr	r0, [sp, #4]
	bl	_ZdlPv(PLT)
.L20:
...
.L23:
	.align	2
.L22:
	.word	_ZTV25b2PolygonAndCircleContact-(.LPIC1+8)
	.cfi_endproc
.LFE552:
	.size	_ZN25b2PolygonAndCircleContactD2Ev, .-_ZN25b2PolygonAndCircleContactD2Ev
	.weak	_ZN25b2PolygonAndCircleContactD1Ev
	.hidden	_ZN25b2PolygonAndCircleContactD1Ev
	.set	_ZN25b2PolygonAndCircleContactD1Ev,_ZN25b2PolygonAndCircleContactD2Ev
...
.LCFI12:
	...
	.loc 5 33 0
	ldr	r0, [sp, #4]
	bl	_ZN25b2PolygonAndCircleContactD1Ev(PLT)
	ldr	r0, [sp, #4]
	bl	_ZdlPv(PLT)
	ldr	r3, [sp, #4]
	mov	r0, r3
...
.LFB555:
	.file 6 "c:/Users/Ben/Desktop/FYP/FinalYearProject/box2d/Box2D/Dynamics/Contacts/b2PolygonAndCircleContact.cpp"
	.loc 6 26 0
	.cfi_startproc
...
.LBB4:
	...
	ldr	r1, [sp, #12]
	ldr	r2, [sp, #4]
	bl	_ZN25b2PolygonAndCircleContactC1EP9b2FixtureS1_(PLT)
	mov	r3, r4
.LBE4:
	.loc 6 29 0
	mov	r0, r3
...
.LC0:
	...
	.ascii	"2D/Dynamics/Contacts/b2PolygonAndCircleContact.cpp\000"
	.align	2
.LC1:
...
.L31:
	...
	cmp	r3, #0
	beq	.L32
	.loc 6 41 0 is_stmt 0 discriminator 1
	ldr	r3, .L34+12
.LPIC5:
	add	r3, pc, r3
	mov	r0, r3
...
.L35:
	.align	2
.L34:
	.word	_ZTV25b2PolygonAndCircleContact-(.LPIC2+8)
	.word	.LC0-(.LPIC3+8)
	.word	.LC1-(.LPIC4+8)
	.word	.LC0-(.LPIC5+8)
	.word	.LC2-(.LPIC6+8)
...
.LFE558:
	...
	.set	_ZN25b2PolygonAndCircleContactC1EP9b2FixtureS1_,_ZN25b2PolygonAndCircleContactC2EP9b2FixtureS1_
...
.LCFI20:
	...
	mov	r1, r4
	ldr	r2, [sp, #12]
	bl	_Z25b2CollidePolygonAndCircleP10b2ManifoldPK14b2PolygonShapeRK11b2TransformPK13b2CircleShapeS6_(PLT)
	.loc 6 49 0
	add	sp, sp, #24
	@ sp needed
	ldmfd	sp!, {r4, pc}
...
.LASF546:
	.ascii	"_ZN25b2PolygonAndCircleContactD2Ev\000"
.LASF136:
	.ascii	"e_chain\000"
.LASF39:
...
.LASF445:
	.ascii	"isSensor\000"
.LASF551:
	.ascii	"_ZN25b2PolygonAndCircleContactC2EP9b2FixtureS1_\000"
.LASF518:
...
.LASF429:
	...
	.ascii	"ransform\000"
.LASF534:
	.ascii	"_ZN25b2PolygonAndCircleContact6CreateEP9b2FixtureiS"
	.ascii	"1_iP16b2BlockAllocator\000"
.LASF554:
...
.LASF62:
	.ascii	"b2Sweep\000"
.LASF533:
	.ascii	"b2PolygonAndCircleContact\000"
.LASF395:
...
.LASF184:
	.ascii	"FILE\000"
.LASF538:
	.ascii	"_ZN25b2PolygonAndCircleContact8EvaluateEP10b2Manifo"
	.ascii	"ldRK11b2TransformS4_\000"
.LASF514:
...
.LASF455:
	.ascii	"proxyId\000"
.LASF535:
	.ascii	"_ZN25b2PolygonAndCircleContact7DestroyEP9b2ContactP"
	.ascii	"16b2BlockAllocator\000"
.LASF78:
...
.LASF547:
	.ascii	"_ZN25b2PolygonAndCircleContactD0Ev\000"
.LASF419:
