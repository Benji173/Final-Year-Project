...
.LFE527:
	...
	.section	.text._ZN16b2PolygonContactD2Ev,"axG",%progbits,_ZN16b2PolygonContactD5Ev,comdat
	.align	2
	.weak	_ZN16b2PolygonContactD2Ev
	.hidden	_ZN16b2PolygonContactD2Ev
	.type	_ZN16b2PolygonContactD2Ev, %function
_ZN16b2PolygonContactD2Ev:
.LFB552:
	.file 5 "c:/users/ben/desktop/fyp/finalyearproject/box2d/Box2D/Dynamics/Contacts/b2PolygonContact.h"
	.loc 5 34 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
...
.L23:
	.align	2
.L22:
	.word	_ZTV16b2PolygonContact-(.LPIC1+8)
	.cfi_endproc
.LFE552:
	.size	_ZN16b2PolygonContactD2Ev, .-_ZN16b2PolygonContactD2Ev
	.weak	_ZN16b2PolygonContactD1Ev
	.hidden	_ZN16b2PolygonContactD1Ev
	.set	_ZN16b2PolygonContactD1Ev,_ZN16b2PolygonContactD2Ev
...
.LCFI12:
	...
	.loc 5 34 0
	ldr	r0, [sp, #4]
	bl	_ZN16b2PolygonContactD1Ev(PLT)
	ldr	r0, [sp, #4]
	bl	_ZdlPv(PLT)
	ldr	r3, [sp, #4]
	mov	r0, r3
...
.LFB586:
	.file 6 "c:/Users/Ben/Desktop/FYP/FinalYearProject/box2d/Box2D/Dynamics/Contacts/b2PolygonContact.cpp"
	.loc 6 29 0
	.cfi_startproc
...
.LBB4:
	...
	ldr	r1, [sp, #12]
	ldr	r2, [sp, #4]
	bl	_ZN16b2PolygonContactC1EP9b2FixtureS1_(PLT)
	mov	r3, r4
.LBE4:
	.loc 6 32 0
	mov	r0, r3
...
.LC0:
	...
	.ascii	"2D/Dynamics/Contacts/b2PolygonContact.cpp\000"
	.align	2
.LC1:
...
.L35:
	.align	2
.L34:
	.word	_ZTV16b2PolygonContact-(.LPIC2+8)
	.word	.LC0-(.LPIC3+8)
	.word	.LC1-(.LPIC4+8)
	.word	.LC0-(.LPIC5+8)
	.word	.LC2-(.LPIC6+8)
...
.LFE589:
	...
	.set	_ZN16b2PolygonContactC1EP9b2FixtureS1_,_ZN16b2PolygonContactC2EP9b2FixtureS1_
...
.LCFI20:
	...
	mov	r1, r4
	ldr	r2, [sp, #12]
	bl	_Z17b2CollidePolygonsP10b2ManifoldPK14b2PolygonShapeRK11b2TransformS3_S6_(PLT)
	.loc 6 52 0
	add	sp, sp, #24
	@ sp needed
	ldmfd	sp!, {r4, pc}
...
.LASF185:
	.ascii	"__XXFILE\000"
.LASF565:
	.ascii	"_ZN16b2PolygonContactC2EP9b2FixtureS1_\000"
.LASF346:
...
.LASF459:
	.ascii	"b2Contact\000"
.LASF560:
	.ascii	"_ZN16b2PolygonContactD2Ev\000"
.LASF354:
...
.LASF561:
	.ascii	"_ZN16b2PolygonContactD0Ev\000"
.LASF97:
