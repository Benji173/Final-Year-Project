...
.LFE527:
	...
	.section	.text._ZN24b2ChainAndPolygonContactD2Ev,"axG",%progbits,_ZN24b2ChainAndPolygonContactD5Ev,comdat
	.align	2
	.weak	_ZN24b2ChainAndPolygonContactD2Ev
	.hidden	_ZN24b2ChainAndPolygonContactD2Ev
	.type	_ZN24b2ChainAndPolygonContactD2Ev, %function
_ZN24b2ChainAndPolygonContactD2Ev:
.LFB552:
	.file 6 "c:/users/ben/desktop/fyp/finalyearproject/box2d/Box2D/Dynamics/Contacts/b2ChainAndPolygonContact.h"
	.loc 6 34 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
...
.L35:
	.align	2
.L34:
	.word	_ZTV24b2ChainAndPolygonContact-(.LPIC2+8)
	.cfi_endproc
.LFE552:
	.size	_ZN24b2ChainAndPolygonContactD2Ev, .-_ZN24b2ChainAndPolygonContactD2Ev
	.weak	_ZN24b2ChainAndPolygonContactD1Ev
	.hidden	_ZN24b2ChainAndPolygonContactD1Ev
	.set	_ZN24b2ChainAndPolygonContactD1Ev,_ZN24b2ChainAndPolygonContactD2Ev
...
.LCFI17:
	...
	.loc 6 34 0
	ldr	r0, [sp, #4]
	bl	_ZN24b2ChainAndPolygonContactD1Ev(PLT)
	ldr	r0, [sp, #4]
	bl	_ZdlPv(PLT)
	ldr	r3, [sp, #4]
	mov	r0, r3
...
.LFB564:
	.file 8 "c:/Users/Ben/Desktop/FYP/FinalYearProject/box2d/Box2D/Dynamics/Contacts/b2ChainAndPolygonContact.cpp"
	.loc 8 28 0
	.cfi_startproc
...
.LBB7:
	...
	ldr	r2, [sp, #16]
	ldr	r3, [sp, #12]
	bl	_ZN24b2ChainAndPolygonContactC1EP9b2FixtureiS1_i(PLT)
	mov	r3, r4
.LBE7:
	.loc 8 31 0
	mov	r0, r3
...
.LC0:
	...
	.ascii	"2D/Dynamics/Contacts/b2ChainAndPolygonContact.cpp\000"
	.align	2
.LC1:
...
.L57:
	.align	2
.L56:
	.word	_ZTV24b2ChainAndPolygonContact-(.LPIC5+8)
	.word	.LC0-(.LPIC6+8)
	.word	.LC1-(.LPIC7+8)
	.word	.LC0-(.LPIC8+8)
	.word	.LC2-(.LPIC9+8)
...
.LFE567:
	...
	.set	_ZN24b2ChainAndPolygonContactC1EP9b2FixtureiS1_i,_ZN24b2ChainAndPolygonContactC2EP9b2FixtureiS1_i
...
.LASF165:
	.ascii	"atof\000"
.LASF550:
	.ascii	"_ZN24b2ChainAndPolygonContactD0Ev\000"
.LASF166:
	.ascii	"atoi\000"
.LASF167:
	.ascii	"atol\000"
...
.LASF62:
	.ascii	"b2Sweep\000"
.LASF549:
	.ascii	"_ZN24b2ChainAndPolygonContactD2Ev\000"
.LASF396:
...
.LASF558:
	.ascii	"_ZN24b2ChainAndPolygonContactC2EP9b2FixtureiS1_i\000"
.LASF356:
	.ascii	"GetNext\000"
.LASF48:
	.ascii	"Skew\000"
