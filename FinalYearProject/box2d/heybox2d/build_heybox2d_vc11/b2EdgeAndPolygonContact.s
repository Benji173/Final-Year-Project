...
.LFE527:
	...
	.section	.text._ZN23b2EdgeAndPolygonContactD2Ev,"axG",%progbits,_ZN23b2EdgeAndPolygonContactD5Ev,comdat
	.align	2
	.weak	_ZN23b2EdgeAndPolygonContactD2Ev
	.hidden	_ZN23b2EdgeAndPolygonContactD2Ev
	.type	_ZN23b2EdgeAndPolygonContactD2Ev, %function
_ZN23b2EdgeAndPolygonContactD2Ev:
.LFB552:
	.file 5 "c:/users/ben/desktop/fyp/finalyearproject/box2d/Box2D/Dynamics/Contacts/b2EdgeAndPolygonContact.h"
	.loc 5 34 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
...
.L23:
	.align	2
.L22:
	.word	_ZTV23b2EdgeAndPolygonContact-(.LPIC1+8)
	.cfi_endproc
.LFE552:
	.size	_ZN23b2EdgeAndPolygonContactD2Ev, .-_ZN23b2EdgeAndPolygonContactD2Ev
	.weak	_ZN23b2EdgeAndPolygonContactD1Ev
	.hidden	_ZN23b2EdgeAndPolygonContactD1Ev
	.set	_ZN23b2EdgeAndPolygonContactD1Ev,_ZN23b2EdgeAndPolygonContactD2Ev
...
.LCFI12:
	...
	.loc 5 34 0
	ldr	r0, [sp, #4]
	bl	_ZN23b2EdgeAndPolygonContactD1Ev(PLT)
	ldr	r0, [sp, #4]
	bl	_ZdlPv(PLT)
	ldr	r3, [sp, #4]
	mov	r0, r3
...
.LFB555:
	.file 6 "c:/Users/Ben/Desktop/FYP/FinalYearProject/box2d/Box2D/Dynamics/Contacts/b2EdgeAndPolygonContact.cpp"
	.loc 6 26 0
	.cfi_startproc
...
.LBB4:
	...
	ldr	r1, [sp, #12]
	ldr	r2, [sp, #4]
	bl	_ZN23b2EdgeAndPolygonContactC1EP9b2FixtureS1_(PLT)
	mov	r3, r4
.LBE4:
	.loc 6 29 0
	mov	r0, r3
...
.LC0:
	...
	.ascii	"2D/Dynamics/Contacts/b2EdgeAndPolygonContact.cpp\000"
	.align	2
.LC1:
	.ascii	"m_fixtureA->GetType() == b2Shape::e_edge\000"
	.align	2
.LC2:
...
.L35:
	.align	2
.L34:
	.word	_ZTV23b2EdgeAndPolygonContact-(.LPIC2+8)
	.word	.LC0-(.LPIC3+8)
	.word	.LC1-(.LPIC4+8)
	.word	.LC0-(.LPIC5+8)
	.word	.LC2-(.LPIC6+8)
...
.LFE558:
	...
	.set	_ZN23b2EdgeAndPolygonContactC1EP9b2FixtureS1_,_ZN23b2EdgeAndPolygonContactC2EP9b2FixtureS1_
...
.LCFI20:
	...
	mov	r1, r4
	ldr	r2, [sp, #12]
	bl	_Z23b2CollideEdgeAndPolygonP10b2ManifoldPK11b2EdgeShapeRK11b2TransformPK14b2PolygonShapeS6_(PLT)
	.loc 6 49 0
	add	sp, sp, #24
	@ sp needed
	ldmfd	sp!, {r4, pc}
...
.LASF547:
	.ascii	"_ZN23b2EdgeAndPolygonContactD0Ev\000"
.LASF501:
...
.LASF164:
	.ascii	"atof\000"
.LASF534:
	.ascii	"_ZN23b2EdgeAndPolygonContact6CreateEP9b2FixtureiS1_"
...
.LASF538:
	.ascii	"_ZN23b2EdgeAndPolygonContact8EvaluateEP10b2Manifold"
...
.LASF136:
	.ascii	"e_chain\000"
.LASF535:
	.ascii	"_ZN23b2EdgeAndPolygonContact7DestroyEP9b2ContactP16"
...
.LASF533:
	.ascii	"b2EdgeAndPolygonContact\000"
.LASF312:
...
.LASF241:
	.ascii	"m_world\000"
.LASF551:
	.ascii	"_ZN23b2EdgeAndPolygonContactC2EP9b2FixtureS1_\000"
.LASF216:
...
.LASF36:
	.ascii	"operator-=\000"
.LASF546:
	.ascii	"_ZN23b2EdgeAndPolygonContactD2Ev\000"
.LASF451:
